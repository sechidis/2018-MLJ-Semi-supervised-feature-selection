function [selectedFeatures] = semiIAMB(X_data, Y_proxy, alpha, prior_y)
% Summary 
%    Using Semi-JMI algorithm (Sechidis Brown, 2017) to select features in 
...
selectedFeatures = IAMB(X_data,Y_labels, alpha);