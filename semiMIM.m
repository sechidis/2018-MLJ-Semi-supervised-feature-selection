function [selectedFeatures] = semiMIM(X_data, Y_proxy, topK, prior_y)
% Summary 
%    Semi-MIM algorithm for feature selection (Sechidis Brown, 2017)
% Inputs
...
selectedFeatures = MIM(X_data,Y_labels, topK);